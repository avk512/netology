...
for word in wordslist:
    words_count[word] = wordslist.count(word)  # создаем словарь с парами: слово: количество


# функция выбора 2-го значения из кортежа (с количеством-частотой упоминания слова)
def mysort(tuple):
    return tuple[1]  # возврат из кортежа 2-го значения (частота упоминания слова)
